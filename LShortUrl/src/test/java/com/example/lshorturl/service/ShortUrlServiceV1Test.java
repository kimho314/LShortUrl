...
public class ShortUrlServiceV1Test {
    ...
    void shortenUrlTest_NewShortenedUrl() {
        ...
        String shortenUrlWithHost = "http://tiny.com/T1IE1ozloHPO4eflBZs7s4wjOjFD";
        ...
        Mockito.when(shortenUrlGenerator.getShortUrlWithHost(anyString()))
                .thenReturn(shortenUrlWithHost);
        ...
        Assertions.assertEquals(shortenUrlWithHost, saveShortenUrlResponseDto.shortenUrl());
    }
